...
/**
 * Multinegocio (spec §20): cambia la empresa activa del usuario. Siempre
 * verifica que la empresa pertenezca al usuario autenticado antes de
 * guardar la cookie — nunca confía en el id recibido sin validarlo.
 */
